...
class ResumeOrStatsDialog(private val context: Context, private val openedFromStartPoint: Boolean = false) {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    btnResume.setOnClickListener {
                        ...
                        val intent = Intent(context, StartPointActivity::class.java)
                    ...
                    btnDelete.setOnClickListener {
                        val deleteMatchDialog = DeleteMatchDialog(context)
