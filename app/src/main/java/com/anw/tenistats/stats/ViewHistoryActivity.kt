...
import com.anw.tenistats.adapter.HistoryArrayAdapter
...
class ViewHistoryActivity : AppCompatActivity() {
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    buttonAll.setOnClickListener {
                        ...
                        buttonAll.setTextColor(ContextCompat.getColor(this@ViewHistoryActivity,
                            R.color.white
                        ))
                        buttonSet1.setBackgroundResource(R.drawable.rec_btn_not_selected)
                        buttonSet1.setTextColor(ContextCompat.getColor(this@ViewHistoryActivity,
                            R.color.general_text_color
                        ))
                        buttonSet2.setBackgroundResource(R.drawable.rec_btn_not_selected)
                        buttonSet2.setTextColor(ContextCompat.getColor(this@ViewHistoryActivity,
                            R.color.general_text_color
                        ))
                        buttonSet3.setBackgroundResource(R.drawable.rec_btn_not_selected)
                        buttonSet3.setTextColor(ContextCompat.getColor(this@ViewHistoryActivity,
                            R.color.general_text_color
                        ))
    ...
    private fun displayMatchPoints(pointsList: List<String>, player1Name: String?, player2Name: String?) {
        ...
        val adapter = HistoryArrayAdapter(this, pointsList, player1Name, player2Name)
