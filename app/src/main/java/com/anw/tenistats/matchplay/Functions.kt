...
fun fillUpScoreInActivity(app: StatsClass, player1: TextView, player2: TextView, serve1: TextView, serve2: TextView,
...
//wyliczenie wyniku
fun score(app: StatsClass, player1: TextView, serve1: TextView, serve2: TextView, pkt1: TextView, pkt2: TextView, set1p1: TextView, set1p2: TextView, set2p1: TextView, set2p2: TextView, set3p1: TextView, set3p2: TextView) {
    var serwis1: String
    var serwis2: String
...
fun fillUpScore(app: StatsClass, player1: TextView, pkt1: TextView, pkt2: TextView,
...
fun fillUpScoreUndoCustom(app: StatsClass, player1: String, pkt1: String, pkt2: String,
