...
class ViewStatsActivity : AppCompatActivity() {
    ...
    //lista rozwijana TOTAL,RETURN,WINNERS,FORCED ERR.,UNFOR. ERR.
        ...
        binding.buttonAllStats.setOnClickListener {
            ...
            binding.buttonSet1Stats.setTextColor(ContextCompat.getColor(this, R.color.general_text_color))
            binding.buttonSet2Stats.setBackgroundResource(R.drawable.rec_btn_not_selected)
            binding.buttonSet2Stats.setTextColor(ContextCompat.getColor(this, R.color.general_text_color))
        ...
        binding.buttonSet1Stats.setOnClickListener {
            ...
            binding.buttonAllStats.setTextColor(ContextCompat.getColor(this, R.color.general_text_color))
    ...
    fun setAppValues(app: Stats, setNumber: Int, player1name: TextView, player2name: TextView, position: Int){
    ...
    fun refreshNumbers(app: Stats, position: Int) {
        when (position){
            0 -> {
